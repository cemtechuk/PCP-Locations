...
<div style="background:#fff; border-bottom:1px solid #e0e0e0; padding:1.5rem 0;">
    <div class="container">
        <div class="s-label mb-1">ADMIN / DATA</div>
...
<div class="container py-4" style="max-width:720px;">
    ...
    <div style="margin-top:2rem;">
        ...
        <p style="font-size:.83rem; color:#555; margin-bottom:.8rem;">
            The CSV must have a header row. Rows with a matching <code>db</code> + <code>exchange</code> + <code>cab</code> combination already in the database are silently skipped — safe to re-import without creating duplicates.
            Column names are case-insensitive. Both <code>long</code> and <code>lng</code> are accepted for longitude.
        </p>
        ...
        <table class="s-table" style="font-size:.8rem;">
            ...
            <tbody>
                <tr>
                    <td class="cab-id">db</td>
                    <td style="color:#2a7a2a; font-family:'Share Tech Mono',monospace; font-size:.72rem;">YES</td>
                    <td style="color:#555;">Short region code, e.g. <code>CL</code></td>
                </tr>
                <tr>
                    <td class="cab-id">db_name</td>
                    <td style="color:#2a7a2a; font-family:'Share Tech Mono',monospace; font-size:.72rem;">YES</td>
                    <td style="color:#555;">Region name, e.g. <code>Central London</code></td>
                </tr>
                <tr>
                    <td class="cab-id">exchange</td>
                    <td style="color:#2a7a2a; font-family:'Share Tech Mono',monospace; font-size:.72rem;">YES</td>
                    <td style="color:#555;">Exchange name. Automatically uppercased on import.</td>
                </tr>
                <tr>
                    <td class="cab-id">cab</td>
                    <td style="color:#2a7a2a; font-family:'Share Tech Mono',monospace; font-size:.72rem;">YES</td>
                    <td style="color:#555;">Cabinet ID, e.g. <code>P1</code>. Use <code>EXCH</code> for the exchange building row. Automatically uppercased.</td>
                </tr>
                <tr>
                    <td class="cab-id">address</td>
                    <td style="color:#999; font-family:'Share Tech Mono',monospace; font-size:.72rem;">NO</td>
                    <td style="color:#555;">Street address of the cabinet.</td>
                </tr>
                <tr>
                    <td class="cab-id">lat</td>
                    <td style="color:#999; font-family:'Share Tech Mono',monospace; font-size:.72rem;">NO</td>
                    <td style="color:#555;">Latitude (WGS84 decimal).</td>
                </tr>
                <tr>
                    <td class="cab-id">long / lng</td>
                    <td style="color:#999; font-family:'Share Tech Mono',monospace; font-size:.72rem;">NO</td>
                    <td style="color:#555;">Longitude (WGS84 decimal). Both column names accepted.</td>
                </tr>
                <tr>
                    <td class="cab-id">notes</td>
                    <td style="color:#999; font-family:'Share Tech Mono',monospace; font-size:.72rem;">NO</td>
                    <td style="color:#555;">Any additional notes.</td>
                </tr>
            </tbody>
        </table>
